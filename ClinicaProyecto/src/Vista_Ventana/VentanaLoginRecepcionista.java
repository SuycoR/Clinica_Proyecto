...
public class VentanaLoginRecepcionista extends javax.swing.JFrame {
    ...
    //Usas el metodo setIdRecepionista del ObjGrabarCita
    ...
    private void jButtonIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIniciarSesionActionPerformed
        ...
        objRecepcionista.setUsuario(usuario);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaLoginRecepcionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaLoginRecepcionista().setVisible(true);
            }
        });
    }
